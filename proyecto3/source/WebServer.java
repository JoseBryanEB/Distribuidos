...
public class WebServer {
    ...
    public static void main(String[] args) {
      // por default el webServer trabaja en el puerto 8080
        ...
        Path path = Paths.get("../BIBLIA_COMPLETA.txt");
        ...
        //prueba
        //System.out.println(new String(calculateResponse("ho".getBytes())));
    ...
    private  byte[] calculateResponse(byte[] requestBytes) {
        ...
        String sTextoBuscado = bodyString.toUpperCase();
        //System.out.println(lines.size());
        //BigInteger result = BigInteger.ONE;
        int contador =0 ;
        for (String line : lines) {
          String sTexto = line.toUpperCase();
        ...
        System.out.println(String.format("Palabra \"%s\": #%s",bodyString,contador));
        return String.format("%s: #%s",bodyString, contador).getBytes();
    }
